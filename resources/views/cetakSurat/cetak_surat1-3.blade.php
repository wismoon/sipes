...
<div style="position:absolute;left:231.01px;top:166.46px" class="cls_014"><span class="cls_014">SURAT KETERANGAN</span></div>
...
<p style="font-size: 14px">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Yang bertanda tangan Kepala Desa Tarai Bangun Kecamatan Tambang Kabupaten Kampar dengan ini menerangkan bahwa :
...
<p style="font-size: 14px">
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Nama tersebut diatas Diizinkan untuk Melaksanakan Kerja Praktek tentang <span class="cls_012" style="text-transform: capitalize"> " {{$surat->judulkp}} "</span> di Desa Tarai Bangun Kecamatan Tambang Kabupaten Kampar.
</p>
</div>

...
<div style="position:absolute;left:193.13px;top:160.70px" class="cls_014"><span class="cls_014">SURAT KETERANGAN USAHA</span></div>
<div style="position:absolute;left:200.93px;top:180.62px" class="cls_009"><span class="cls_009">Nomor : 510 /SK/TRB/ V / 2021/</span></div>
<div style="position:absolute;left:87.74px;top:226.58px" class="cls_011"><span class="cls_011">Kepala  Desa  Tarai  Bangun  Kecamatan  Tambang  Kabupaten  Kamper  dengan  ini</span></div>
<div style="position:absolute;left:59.28px;top:249.02px" class="cls_011"><span class="cls_011">menerangkan bahwa :</span></div>
<div style="position:absolute;left:87.62px;top:310.01px" class="cls_011"><span class="cls_011">Nama</span></div>
<div style="position:absolute;left:229.49px;top:310.01px" class="cls_011"><span class="cls_011">: </span><span class="cls_012">{{$surat->nama}}</span></div>
<div style="position:absolute;left:87.62px;top:332.45px" class="cls_011"><span class="cls_011">Tempat/Tanggal Lahir</span></div>
<div style="position:absolute;left:229.49px;top:332.45px" class="cls_011"><span class="cls_011" style="text-transform: uppercase">: {{$surat->tempatlahir.", ".$surat->tanggallahir}}</span></div>
<div style="position:absolute;left:87.62px;top:354.89px" class="cls_011"><span class="cls_011">Kewarganegaraan</span></div>
<div style="position:absolute;left:229.49px;top:354.89px" class="cls_011"><span class="cls_011">: Indonesia</span></div>
<div style="position:absolute;left:87.62px;top:377.33px" class="cls_011"><span class="cls_011">Jenis Kelamin</span></div>
<div style="position:absolute;left:229.49px;top:377.33px" class="cls_011"><span class="cls_011">: {{$surat->jeniskelamin}}</span></div>
<div style="position:absolute;left:87.62px;top:399.77px" class="cls_011"><span class="cls_011">Agama</span></div>
<div style="position:absolute;left:229.49px;top:399.77px" class="cls_011" text-transform="uppercase"><span class="cls_011">: {{$surat->agama}}</span></div>
<div style="position:absolute;left:87.62px;top:422.21px" class="cls_011"><span class="cls_011">Pekerjaan</span></div>
<div style="position:absolute;left:229.49px;top:422.21px" class="cls_011"><span class="cls_011">: {{$surat->pekerjaan}}</span></div>
...
<div style="position:absolute;left:442.03px;top:730.90px" class="cls_007"><span class="cls_007">: {{$surat->tanggal}}</span></div>
